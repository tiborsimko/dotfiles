---
name: relay-copy
description: Copy the most recently prepared relay packet to the clipboard, ready to paste into a collaborating AI agent's pane. Run after $relay-prepare. Invoke only when the user explicitly runs $relay-copy; never auto-trigger.
---

<!-- Keep behavior in sync with the Claude relay-copy skill counterpart at claude/.claude/skills/relay-copy/SKILL.md -->
