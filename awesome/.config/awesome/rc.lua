-- Tibor's AwesomeWM configuration.
...
-- Battery widget via vicious
mybatwidget = wibox.widget.textbox()
vicious.register(mybatwidget, vicious.widgets.bat, " Bat $2%$1", 61, "BAT0")
...
awful.screen.connect_for_each_screen(function(s)
    ...
    -- Create the wibox
    s.mywibox = awful.wibar({ position = "top", height = 14, screen = s })
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey,           }, "0", awful.tag.history.restore,
              {description = "go back", group = "tag"}),
    ...
    awful.key({ modkey,           }, "w", function () awful.spawn("rofi -theme gruvbox-dark-hard -show window -font 'Source Code Pro 10'") end,
              {description = "show window menu", group = "awesome"}),
    ...
    -- Prompt
    awful.key({ modkey },            "r",     function () awful.spawn("rofi -theme gruvbox-dark-hard -show run -font 'Source Code Pro 10'") end,
