...
ENCRYPTION_PIPE = ["gpg", "--encrypt", "--recipient", "tibor.simko@cern.ch"]
...
registrations = {
    ...
    "microsoft": {
        ...
        # Thunderbird's well-known public OAuth client credentials; these are
        # not credentials for a private tenant registration.
